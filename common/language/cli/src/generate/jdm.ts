 ...
 *   app-with-ai-tanstack/packages/web/src/lib/jdm-converter.ts  (convertToJdm)
 *
 * That path is deliberately into the subfolder rather than a vendored copy
 * beside this file: the whole point of using the shipped converter is that the
 * CLI and the modelling tool cannot disagree about what a rule flow compiles
 * to, and a second copy is exactly how they would come to.
 *
...
import type {
  ...
  FlowNode,
  NodeShape,
} from "../../../../../app-with-ai-tanstack/packages/web/src/lib/mermaid-flowchart-parser.ts";
