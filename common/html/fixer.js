    ...
    reserved: [
      ...
      },
      {
        ...
        consumedBy: [
          ...
          "common/build/reporting-pack.ts -> one reporting role per declared role, scoped to the tables that role may read"
        ],
      ...
      },
      {
        ...
        consumedBy: [
          ...
          "common/language/checker.ts (shape only: EML290-EML296)",
          "common/build/reporting-pack.ts (authored reports, listed ahead of the derived ones)",
          "enterprise_reporting_tanstack/scripts/seed-reporting-pack.ts -> saved_queries / report_definitions / chart_definitions in the reporting platform"
        ],
        ...
        notes: {
          ...
          whereItIsCompiled: "Compiled twice, by two readers, and neither replaces the other. In app-with-ai-tanstack, packages/generator/src/reports/index.ts puts each report into the generated application itself: a sys_report row served at /sys/reports and shown under Admin > Analysis in the NestJS stack, and a model.json entry served at /api/reports and shown under Reports in the browser application. Here, common/build/reporting-pack.ts compiles the same directive into a saved query, a report definition and, where chart: is set, a chart, seeded into the Enterprise Reporting platform ahead of the derived baseline. That platform is composed beside a deployed application by docker-compose; it is not in the browser application and not in the downloadable zip.",
