...
const insertWh = db.query(
  "INSERT INTO warehouses (name, code, address, city, region_id, manager_id, capacity) VALUES (?, ?, ?, ?, ?, ?, ?)"
);
for (let i = 0; i < 20; i++) {
